   ...
   //--------------------------------- FIN Validaciones ----------------------
    ...
    <div className="container">
        ...
        <form className="form" onSubmit={handleSubmit} > 
          ...
          <label> Correo electrónico  <input name="email" type='email' value={formValues.email} onChange={handleChangeFormValues} onBlur={hadleBlurEmail}/> <span style={{ visibility: BadEmail ? "visible" : "hidden"}}>El email no es correcto</span> <br></br> </label>
          
          <label> Contraseña <input name="password" type={showPwd ? "text" : "password"} value={formValues.password} onChange={handleChangeFormValues} onBlur={hadleBlurPass} /> <span style={{ visibility: badPassword ? "visible" : "hidden"}}>El password no es correcto</span> <br></br></label>
